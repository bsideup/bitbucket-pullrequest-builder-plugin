...
public class BitbucketRepository {
    ...
    public void addFutureBuildTasks(Collection<Pullrequest> pullRequests) {
        for(Pullrequest pullRequest : pullRequests) {
            ...
            setBuildStatus(pullRequest.getSource().getCommit().getHash(), cause.getDestinationCommitHash(), BuildState.INPROGRESS, Jenkins.getInstance().getRootUrl());
            this.builder.getTrigger().startJob(cause);
        }
    }

    public void setBuildStatus(String sourceCommit, String destinationBranch, BuildState state, String buildUrl) {
        String comment = null;
        ...
        this.client.setBuildStatus(sourceCommit, state, buildUrl, comment);
    }
    ...
    private boolean isBuildTarget(Pullrequest pullRequest) {
        if (pullRequest.getState() != null && pullRequest.getState().equals("OPEN")) {
            ...
            if (this.client.hasBuildStatus(sourceCommit)) {
